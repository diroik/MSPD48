...
/*
  ...
  MaxLen:
*/
const unsigned short Crc16TableCcitt[256] = {
...
Byte   	FloatToString(Byte *ReturnBUF, float Val, int AllSymb=6, int AfteComma=3);//string
string 	FloatToString(float Val, int AllSymb = 0, int AfteComma = 2);
Byte   	IntToString(Byte *ReturnBUF, int Val, int AllSymb=4);
string 	IntToString(int Val, int AllSymb = 0);
string 	WordToString(Word Val, int AllSymb = 0);
string 	LongToString(long Val, int AllSymb = 0);
string  LongLongToString(long long Val, int AllSymb);
string  TimeToString(struct tm &time);
string  TimeToString(struct tm *time);
